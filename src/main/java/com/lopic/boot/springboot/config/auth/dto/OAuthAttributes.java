...
public class OAuthAttributes {
    ...
    private static OAuthAttributes ofGoogle(String userNameAttribuName, Map<String, Object> attributes) {
        return OAuthAttributes.builder().name((String) attributes.get("name")).email((String) attributes.get("email")).picture((String) attributes.get("picture"))
                .attributes(attributes).nameAttributeKey(userNameAttribuName)
                .build();
    }
    ...
    private static OAuthAttributes ofNaver(String userNameAttribute, Map<String, Object> attributes) {
        ...
        return OAuthAttributes.builder()
                ...
                .picture((String) response.get("profilImage"))
                .attributes(response)
